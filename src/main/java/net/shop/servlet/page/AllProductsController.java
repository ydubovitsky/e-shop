...
public class AllProductsController extends AbstractController {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int totalCount = getProductService().countAllProducts(); //* Считаем общее количество в БД
		req.setAttribute("pageCount", pageCount(totalCount, MAX_PRODUCTS_PER_HTML_PAGE)); //* Передаем количество страниц с продуктами
